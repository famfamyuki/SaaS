...
> Working title. Product name is intentionally provisional.
...
**Intended destination:** Standalone GitHub repository before implementation
...
Do not start a large build merely because the idea sounds plausible. Resume this project when there is time to run the Phase 0 validation in `ROADMAP.md`. If the validation passes, move this directory into a standalone repository and begin MVP implementation.
